...
### S5 — XRES TINY V3 : ANNULÉ le jour même (2026-09-06)
...
Mesure préalable P-tmp.1 (champion tiny `epoch00_valloss0.5949` en mix-pool) : 0.5529, soit
1.9 pt derrière mini head8 à pile égale — le tiny répond moins aux couches ; décision
...
### BiasIN — correction causale du biais de niveau depuis le backtest — **CLOS 2026-09-08** (médiane : 0.5413 contre 0.5340, 94/97 refus ; oracle constant 0.4431 = dérive réalisée, inaccessible) (0.5428 contre 0.5340, 94/97 refus, les 3 acceptés nuisent : le biais de niveau ne persiste pas)
...
`+refine=ceiling` FAIT (2026-09-07) : boîte 0.16/0.4/0.8/4 σ ⇒ CRPS 0.4443/0.3657/0.3022/0.2932 (asymptote) contre 0.5340 ; le biais tient dans 0.8 σ, G = 16.8 pt à la boîte 0.4 ; `critic_alpha` fixé à 0.05 ; P-S6.1 = récupération 10-25 % sur le checkpoint critic (registre).
