...
three-seed protocol not yet funded. Testable corollary: native h512 (half
the rolls) should shrink the latent advantage; the objective duel and the
horizon lever test each other. \pending{h512 medium/long deltas vs the h256
twin.}
